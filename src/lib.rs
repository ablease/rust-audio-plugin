...
/// A test tone generator that can either generate a sine wave based on the plugins params or
...
struct Sine {
    ...
    /// Current phase of the sine wave between 0-1
    phase: f32,

    /// MIDI not ID of the active note
    midi_note_id: u8,
    /// frequency of note
    midi_note_freq: f32,

    // AR envelope to avoid clicks
